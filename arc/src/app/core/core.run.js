(function () {
    ...
    /** @ngInject */
    function runBlock(msUtils, fuseGenerator, fuseConfig, msApi, $rootScope) {
        /**
        ...
        $rootScope.BASE_URL = msApi.getBaseUrl();
        $rootScope.IS_RELEASE = $rootScope.BASE_URL.indexOf('greenfieldethanol') >= 0;
    }
})();
